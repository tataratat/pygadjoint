    ...
    def optimize(self):
        ...
        optim = scipy.optimize.minimize(
            ...
            bounds=(
                ...
                + [(-1.0, 1.0) for _ in range(n_design_vars_macro)]
            ),
...
def main():
    ...
    parameter_spline_cps_dimensions = [5, 5]
    parameter_default_value = 0.3032910094969204 / 5
    volume_density = 0.5

    scaling_factor_objective_function = 1 / 17125.38659738541
